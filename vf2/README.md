...
```command
firebase deploy --only functions:incrementBoardCount
firebase deploy --only functions:decrementBoardCount
```
...
- [강좌 | Vue와 Firebase로 나만의 사이트 만들기 31 작성일 넣기 | 05:10](https://www.youtube.com/watch?v=i2wbmdSbzeU&list=PLjpTKic1SLZsWckh_DZ6tYH17MM6hBAc7&index=32)